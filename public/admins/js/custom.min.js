...
//funciones para mostrar modal de torneo
function showTournament(slug) {
    ...
    .done(function(resultado) {
        var obj=JSON.parse(resultado);
        $('#nameTournament').text(obj.name);
        $('#groupsTournament').text(obj.groups);
        $('#stateTournament').html(obj.state);
        $("#showTournament").modal();
    });
};
...
//funciones para mostrar modal de club
