...
class GamerController extends Controller
{
    ...
    public function store(GamerStoreRequest $request)
    {
        ...
        if ($gamer) {
            return redirect()->route('jugadores.index')->with(['type' => 'success', 'title' => 'Registro exitoso', 'msg' => 'El jugador ha sido registrado exitosamente.']);
        } else {
            return redirect()->route('jugadores.index')->with(['type' => 'error', 'title' => 'Registro fallido', 'msg' => 'Ha ocurrido un error durante el proceso, intentelo nuevamente.']);
        }
    }
